      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="glass rounded-3xl p-1 overflow-hidden">
            ...
            <div className="bg-white rounded-[1.4rem] p-6 notebook-bg min-h-[400px] flex flex-col">
              ...
              {loading ? (
                ...
                <textarea
                  className="flex-grow w-full bg-transparent resize-none outline-none text-lg"
        ...
        >
              ...
              {TAGS.map((tag) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && (
                      <ChevronRight className={`w-4 h-4 ${tag.color}`} />
                    )}
          ...
          <button
            ...
            className="w-full bg-indigo-600 text-white py-4 rounded-3xl font-bold flex items-center justify-center gap-2"
          >
